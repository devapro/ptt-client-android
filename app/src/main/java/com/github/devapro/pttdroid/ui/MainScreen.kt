...
private fun TalkControl(
    ...
    Column(horizontalAlignment = Alignment.CenterHorizontally) {
        ...
        Text(
            text = stringResource(
                when {
                    !micPermissionGranted -> R.string.permission_mic_required
                    status == PttUiStatus.OFFLINE -> R.string.ptt_offline
                    status == PttUiStatus.CONNECTING -> R.string.status_connecting
                    status == PttUiStatus.RECEIVING -> R.string.ptt_blocked
                    status == PttUiStatus.REQUESTING -> R.string.ptt_requesting
                    status == PttUiStatus.TRANSMITTING -> R.string.ptt_release_to_stop
                    else -> R.string.ptt_hold_to_talk
                },
            ),
