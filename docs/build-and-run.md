...
./gradlew testDebugUnitTest                   # 159 JVM unit tests (:shared, on the androidTarget compilation)
./gradlew :shared:desktopTest                  # the same 159 tests again, on the desktop compilation
