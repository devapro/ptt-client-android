...
class MainScreenTest {
    ...
    fun a_clear_channel_reports_ready_and_counts_the_radios() {
        ...
        rule.onNodeWithText(string(Res.string.status_ready)).assertIsDisplayed()
        rule.onNodeWithText(
            runBlocking { getPluralString(Res.plurals.peers_online, 2, 2) },
        ).assertIsDisplayed()
        rule.onNodeWithText(string(Res.string.ptt_hold_to_talk)).assertIsDisplayed()
    }
    ...
    fun offline_shows_the_address_it_cannot_reach_rather_than_hiding_the_ui() {
        ...
        rule.onNodeWithText(string(Res.string.status_disconnected)).assertIsDisplayed()
        rule.onNodeWithText("10.0.2.2:8000").assertIsDisplayed()
        rule.onNodeWithText(string(Res.string.ptt_offline)).assertIsDisplayed()
        rule.onNodeWithText(string(Res.string.main_connect)).assertIsDisplayed()
    }
    ...
    fun someone_else_talking_is_named_and_the_reason_is_spelled_out() {
        ...
        rule.onNodeWithText(string(Res.string.status_receiving_from).format("Bob")).assertIsDisplayed()
        rule.onNodeWithText(string(Res.string.ptt_blocked)).assertIsDisplayed()
        rule.onNodeWithText(string(Res.string.ptt_cap_busy)).assertIsDisplayed()
    }
    ...
    fun a_missing_microphone_permission_offers_the_fix() {
        ...
        rule.onNodeWithText(string(Res.string.permission_mic_required)).assertIsDisplayed()
        rule.onNodeWithText(string(Res.string.permission_grant)).performClick()
    ...
    fun stepping_the_channel_dispatches_the_new_number() {
        ...
        rule.onNodeWithContentDescription(string(Res.string.cd_channel_up)).performClick()
        rule.onNodeWithContentDescription(string(Res.string.cd_channel_down)).performClick()
    ...
    fun the_channel_ends_disable_instead_of_silently_doing_nothing() {
        ...
        rule.onNodeWithContentDescription(string(Res.string.cd_channel_down)).assertIsNotEnabled()
        rule.onNodeWithContentDescription(string(Res.string.cd_channel_up)).assertIsEnabled()
    }
    ...
    fun the_channel_is_locked_while_transmitting() {
        ...
        rule.onNodeWithContentDescription(string(Res.string.cd_channel_up)).assertIsNotEnabled()
        rule.onNodeWithContentDescription(string(Res.string.cd_channel_down)).assertIsNotEnabled()
    }
    ...
    fun an_error_can_be_dismissed() {
        ...
        rule.onNodeWithContentDescription(string(Res.string.cd_dismiss_error)).performClick()
    ...
    fun the_session_can_be_started_and_stopped_from_the_status_card() {
        ...
        rule.onNodeWithText(string(Res.string.main_disconnect)).performClick()
    ...
    fun a_pending_floor_request_is_visible_rather_than_looking_idle() {
        ...
        rule.onNodeWithText(string(Res.string.ptt_cap_wait)).assertIsDisplayed()
        rule.onNodeWithText(string(Res.string.ptt_requesting)).assertIsDisplayed()
    }
}
