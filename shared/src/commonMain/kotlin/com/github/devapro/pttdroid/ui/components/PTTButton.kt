...
fun PTTButton(
    ...
    val toggleLabel = stringResource(Res.string.cd_ptt_toggle)
...
private fun PttUiStatus.glyph(): DrawableResource = when (this) {
    PttUiStatus.OFFLINE -> Res.drawable.ic_mic_off
    PttUiStatus.RECEIVING -> Res.drawable.ic_volume_up
